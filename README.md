...
| **PROS**     | **CONS**      |
| ---          | ---           |
| <pre><strong>Advantages:</strong><ul><li>Good Documentation, community and support</li><li>With Route, Middleware and Template Management</li><li>Flexible database support/integration</li></ul></pre> | <pre><strong>Things to be considered:</strong><ul><li>template</li></ul></pre> |
