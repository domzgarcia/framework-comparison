...
| **PROS**     | **CONS**      |
| ---          | ---           |
| <pre><strong>Advantages:</strong><ul><li>template</li></ul></pre> | <pre><strong>Things to be considered:</strong><ul><li>Good Documentation</li><li>XXX XXX</li><li>XXX XXX</li><li>XXX XXX</li></ul></pre> |
